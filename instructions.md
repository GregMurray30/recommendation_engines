...
The data sample [files](https://github.com/GregMurray30/recommendation_engines/blob/master/data_sources) are a comma separated value file in the format *[user_id], [movie_id], [rating], [rating_date]*. 
