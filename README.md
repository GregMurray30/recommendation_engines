# !!WORK IN PROGRESS!!
### (The engineered functions are not complete and do not capture the desired behavior exactly as described :/. More specifically, the desired behavior for every event in the sample space of rating difference combinations is not captured satisfactorily with the function from figure 3c.)
