...
calculated as the Pearson correlation coefficient (hence the name) of the two users' shared-movies' ratings. For two users, X and Y, then their sample similarity is defined as 
