...
One major disadvantage of the probabilistic approach to edge weights is that the probability density function cannot be calculated for samples with a variance of zero. This becomes an issue with small sample sizes. In these instances, and 
