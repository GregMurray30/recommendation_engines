...
> **ω<sub>uv<sub>x</sub></sub>(r<sub>u<sub>x</sub></sub>, r<sub>v<sub>x</sub></sub>, σ<sub>x</sub>, r<sub>avg<sub>x</sub></sub> )= (1+|r<sub>u<sub>x</sub></sub>-r<sub>v<sub>x</sub></sub>|)/(1+(1+|r<sub>u<sub>x</sub></sub>-r<sub>avg<sub>x</sub></sub>|<sub>L2</sub>1+|r<sub>v<sub>x</sub></sub>-r<sub>avg<sub>x</sub></sub>|<sub>L2</sub>))^0.5)(σ<sub>x</sub>)**
