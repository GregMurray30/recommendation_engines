...
> **ω<sub>uv<sub>x</sub></sub>(r<sub>u<sub>x</sub></sub>, r<sub>v<sub>x</sub></sub>, σ<sub>x</sub>, r¯<sub>x</sub>)= (1+|r<sub>u<sub>x</sub></sub>-r<sub>v<sub>x</sub></sub>|)/(1+|r<sub>u<sub>x</sub></sub>-r¯<sub>x</sub>|<sub>L2</sub>) *σ<sub>x</sub>**
